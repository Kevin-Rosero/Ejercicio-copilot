...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap swimming, technique clinics, and meets",
    ...
    "Orchestra": {
        "description": "Ensemble rehearsals and performances for orchestral instruments",
    ...
    "Debate Team": {
        "description": "Practice competitive debating, research, and public speaking",
...
def remove_participant(activity_name: str, email: str):
    """Remove/unregister a student from an activity (email passed as query param)
    """
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
